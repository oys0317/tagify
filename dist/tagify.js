...
Tagify.prototype = {
  ...
  loadOriginalValues: function loadOriginalValues(value) {
    value = value || this.DOM.originalInput.value || this.DOM.originalInput.textContent; // if the original input already had any value (tags)
